	...
	\displaystyle\frac
	 {\begin{array}{ll}
            \Gamma'(M)(x) = \left\{ \begin{array}{ll}
             ...
             \end{array}\right.
          \end{array}}
	 {\Gamma \vdash_{\Downarrow} \import\ M\, (\overline{\iitem}) : \Gamma'} \\ \\
...
\[ \begin{array}{cc}
	...
	\displaystyle\frac
	 {\begin{array}{ll}
           ...
           Q;\Gamma \vdash_{\Uparrow}^X \overline{x=e}^{\,n} : ? \text{ como tipar bindings\ldots} \: & \: 
	   Q;\Gamma \vdash_{\Uparrow} \overline{\!d} : (R,Q',\Gamma') 
          \end{array}}
	 {P;\Gamma \vdash_{\Uparrow}^X \instance\ C \Rightarrow T\:\overline{\tau}\ \where\ \overline{x = e}^{\,n};\: \overline{\!d} 
             : (R,P',\Gamma')}\\ \\
