...
\newcommand{\Polymonad}{{\it PolyMonad\/}}
\newcommand{\PolyMonad}{{\it PolyMonad\/}}
\newcommand{\mUm}{{\it m1\/}}
\newcommand{\mDois}{{\it m2\/}}
\newcommand{\mTres}{{\it m3\/}}
\newcommand{\mQuatro}{{\it m4\/}}
\newcommand{\mCinco}{{\it m5\/}}
\newcommand{\morph}{{\it morph\/}}
\newcommand{\Morph}{{\it Morph\/}}
\newcommand{\fmb}{{\it fmb\/}}
\newcommand{\maa}{{\it ma\/}}
...
\newcommand{\putStrLn}{{\it putStrLn\/}}
\newcommand{\String}{{\it String\/}}
\newcommand{\Functor}{{\it Functor\/}}

\newcommand{\Foldable}{{\it Foldable\/}}
